...
public class SavedConfigs {
    ...
    public Config generateTestConfig00(){
        ...
        robotList.add(new Robot(new Coord(2,2), Colors.GREEN));

        ArrayList<Obstacle> obstacleList = new ArrayList<Obstacle>();
        obstacleList.add(new Obstacle(new Coord(0,0),new Coord(4,0), ObsType.HORIZONTAL));
        obstacleList.add(new Obstacle(new Coord(0,0),new Coord(0,3), ObsType.VERTICAL));
